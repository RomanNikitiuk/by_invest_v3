      ...
      <div className="container-px">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p className="lead mt-4">
            Натисніть «Наповнення» біля кожного модуля, щоб побачити детальний
            план занять, домашні завдання та результати, які ви отримаєте.
          </p>
        </div>
        ...
        <div className="mx-auto mt-8 max-w-[920px]">
          <div className="rounded-[24px] bg-white2 border border-line p-8 sm:p-10">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              ...
              ].map(({ when, result, color, dot, dark }) => (
                <div
                  key={when}
