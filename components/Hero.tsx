        ...
        <div className="grid min-w-0 items-center gap-10 lg:grid-cols-12">
          ...
          <div className="min-w-0 lg:col-span-7">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <Link href="/diagnostics" onClick={() => trackEvent("cta_click", { location: "hero" })} className="btn-primary w-full sm:w-auto flex-col items-center gap-0.5 text-center animate-pulse-glow">
              ...
              <Link
                href="#program"
                onClick={() => trackEvent("hero_learn_more_click")}
