  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-radial":
          "radial-gradient(900px 500px at 85% 10%, rgba(90,191,255,0.45), transparent 60%)",
      },
      keyframes: {
        float: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 rgba(90,191,255,0.6)" },
          "50%": { boxShadow: "0 0 0 18px rgba(90,191,255,0)" },
        },
        shimmer: {
